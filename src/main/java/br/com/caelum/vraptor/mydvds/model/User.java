 ...
 * 
 * The class is annotated with <code>@Component</code> and
 * <code>@SessionScoped</code>, thus its instances can be injected to other
 * classes who depend on Users.
 */
@Entity
@Component
@SessionScoped
public class User {
	...
	public Set<Dvd> getDvds() {
		...
		return new HashSet<Dvd>(Collections2.transform(copies,
				new Function<DvdCopy, Dvd>() {
